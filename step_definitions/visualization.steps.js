...
module.exports = function (options) {
  ...
  /**
  * checks if a certain element has a given attribute
  */
  Step(
  ...
  /**
  * Validates the text content matches the given value (can be literal or aliases)
  */
  ...
  /**
  * Validates the text content DOESN'T match the given value (can be literal or aliases)
  */
